...
public class UIManager : MonoBehaviour
{
    ...
    public void MostrarCapituloYNivel (string tituloCapitulo, string subtituloCapitulo, string tituloNivel, string subtituloNivel)
    {
        ...
        imagenYago.transform.position = new Vector2((imagenYago.transform.position.x - 1000), imagenYago.transform.position.y);
        ...
        s.Append(imagenYago.transform.DOMoveX((imagenYago.transform.position.x + 1000), 1));
